...
export function AuthBanner() {
  return <div style={{ minHeight: "100vh", backgroundColor: "black", display: "flex", alignItems: "center" }}>
    <div style={{ width: "100%" }}>
      ...
      <div style={{ display: "flex", justifyContent: "center" }}>
        <div style={{ color: "white", fontWeight: 400, fontFamily: "Inter", fontSize: 30, padding: 20, textAlign: "center" }}>Build a board, Get the job done before anyone else</div>
      </div>
    </div>
  </div>
}
